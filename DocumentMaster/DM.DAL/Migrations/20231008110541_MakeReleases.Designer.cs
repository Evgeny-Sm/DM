...
namespace DM.DAL.Migrations
{
    ...
    [Migration("20231008110541_MakeReleases")]
    partial class MakeReleases
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DM.DAL.Models.NoteToDo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DM.DAL.Models.QuestionsToDo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("QuestionsToDo");
                });

            modelBuilder.Entity("DM.DAL.Models.Release", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FileUnitRelease", b =>
                {
                    b.Property<int>("FileUnitsId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("FileUnitsId", "ReleasesId");

                    b.HasIndex("ReleasesId");

                    b.ToTable("FileUnitRelease");
                });
            ...
            modelBuilder.Entity("DM.DAL.Models.NoteToDo", b =>
                {
                    b.HasOne("DM.DAL.Models.Note", "Note")
                        .WithMany("NoteToDos")
            ...
            modelBuilder.Entity("DM.DAL.Models.Release", b =>
                {
                    b.HasOne("DM.DAL.Models.Person", "Creator")
                        .WithMany("Releases")
                        .HasForeignKey("PersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FileUnitRelease", b =>
                {
                    ...
                    b.HasOne("DM.DAL.Models.Release", null)
                        .WithMany()
